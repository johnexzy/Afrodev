...
The `post.content` is returned as a HTML. In that regards we'll want to insert that html into our page. ReactJs gives us a way to handle that using \`dangerouslySetInnerHTML.
