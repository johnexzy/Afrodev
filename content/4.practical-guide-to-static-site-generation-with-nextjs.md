...
The `post.content` is returned as an HTML. In that regard, we'll want to insert that HTML into our page. ReactJs gives us a way to handle that using \`dangerouslySetInnerHTML.
