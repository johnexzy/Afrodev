...
Listen for intelligibility, pause placement, pitch movement, and stability across the same sentence:

- [Base XTTS model](/audio/voice-model-process/untrained-john-3-16.wav)
- [Earlier XTTS fine-tune](/audio/voice-model-process/earlier-finetune-john-3-16.wav)
- [Selected Gospels model](/audio/voice-model-process/gospels-best-john-3-16.wav)
- [Checkpoint 34,000](/audio/voice-model-process/checkpoint-34000-john-3-16.wav)
