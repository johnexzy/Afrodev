...
description: "Engineering prowess matters less when domain knowledge is lacking"
author: John Oba - Afrodev
date: 11 September, 2025
read_time: 8 min
category: Engineering, Astrology, AI, Product Development
tags: [less-technical, engineering]
---
...
flowchart LR
 subgraph Infra_Services["Infrastructure Services"]
        ...
        Redis["Redis Job Result Store"]
  end
 subgraph Monitoring_Planned["Monitoring (Future)"]
        Prometheus["Prometheus"]
        Logs["Centralized Logging"]
  end
    User["User Request"] --> Django["Django Backend"]
    Django -- POST chartType + input to Kafka --> KafkaBroker
    KafkaBroker --> ChartWorker["Chart Worker (Consumer)"] & KafkaUI["Kafka UI"]
    ChartWorker --> FastAPI["FastAPI Chart API"] & Redis
    Django -- Poll Redis for jobId --> Redis
    Django -- Returns Result --> User
    Django --> PostgreSQL
    Django -- future --> Prometheus & Logs
    ChartWorker -- future --> Logs
```
