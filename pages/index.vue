    ...
    <header class="flex justify-between items-center">
      ...
      <div class="px-2 h-9 items-center flex gap-5">
        <Icon
          ...
          class="text-gray-700 cursor-pointer text-2xl"
        />
        <Icon
    ...
    <main class="mx-auto">
      <div class="text-center my-10">
        <h1 class="text-5xl font-semibold">
          Explore Practical <span class="">Software</span> Development Articles.
        </h1>
      </div>
        ...
        <div>
          ...
          >
            ...
            <a
              href="#"
              aria-current="page"
              class="relative z-10 inline-flex items-center bg-red px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >1</a
            >
            <a
              href="#"
